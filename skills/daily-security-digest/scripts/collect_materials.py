...
def main(argv: list[str] | None = None) -> int:
    ...
    try:
        manifest = run_collection(SCRIPT_DIR.parent / "templates", date_slug=args.date, timezone=args.timezone, days=args.days)
    ...
    print(json.dumps({
        ...
        "workspace_config_path": manifest["workspace_config_path"],
